...
Public Class FrmTypePay
    ...
    Private Sub frmTypepay_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        sel = "Insert into type_of_payment ("
        sel += "payment_name)"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Dim sel As String
        sel = "select * from type_of_payment"
        cmd = New OracleCommand(sel, Conn)
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Dim sel As String
        sel = "UPDATE type_of_payment SET payment_name ='" + TextBox2.Text + "'where payment_name ='" + TextBox2.Text + "'"
        cmd = New OracleCommand(sel, Conn)
        dr = cmd.ExecuteReader
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        sql = "DELETE type_of_payment where payment_name = '" + TextBox2.Text + "'"
    ...
    Private Sub cmdType_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdType.Click
        Dim sel As String
        sel = "select * from type_of_payment where payment_name = '" + TextBox2.Text + "'"
        cmd = New OracleCommand(sel, Conn)
        dr = cmd.ExecuteReader
